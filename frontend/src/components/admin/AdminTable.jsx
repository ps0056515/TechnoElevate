...
export default function AdminTable({ columns, rows, onEdit, onDelete, loading, pageSize = 12 }) {
  const [deletingId, setDeletingId] = useState(null);
  const { page, setPage, totalPages, paginatedData, total } = usePagination(rows, pageSize);
